                ...
                <div className="row gx-lg-5 align-items-center">
                  ...
                  <div className="col-lg-6 mb-5 mb-lg-0" style={{ zIndex: 1 }}>
                    ...
                    <h1 className="my-5 display-3 fw-bold ls-tight">
                      {" "}
                      <span>Stay Curious</span> <br />{" "}
                      <span className="text-primary">Discover stories, thinking and expertise from writers on any topic </span>{" "}
                    </h1>{" "}
                    <a
            ...
            <div className="row gx-lg-5">
              ...
              <div className="col-lg-4 col-md-12 mb-6 mb-lg-0">
                ...
                <div className="card shadow-2-strong">
                  ...
                  <div className="card-body">
                    {" "}
                    <h5 className="card-title">My paradise</h5>{" "}
              ...
              <div className="col-lg-4 mb-6 mb-lg-0">
                ...
                <div className="card shadow-2-strong">
                  ...
                  <div className="card-body">
                    {" "}
                    <h5 className="card-title">Travel to Italy</h5>{" "}
                    <p className="card-text">
              ...
              <div className="col-lg-4 mb-6 mb-lg-0">
                ...
                <div className="card shadow-2-strong">
                  ...
                  <div className="card-body">
                    {" "}
                    <h5 className="card-title">Chasing the sun</h5>{" "}
                    <p className="card-text">
